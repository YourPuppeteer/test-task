$('#productType').on('change', function() {
    ...
    if (selectedType === 'DVD') {
        includeComponent('src/public/Inputs/dvd_component.html');
    } else if (selectedType === 'Book') {
        includeComponent('src/public/Inputs/book_component.html');
    } else if (selectedType === 'Furniture') {
        includeComponent('src/public/Inputs/furniture_component.html');
    }
});
